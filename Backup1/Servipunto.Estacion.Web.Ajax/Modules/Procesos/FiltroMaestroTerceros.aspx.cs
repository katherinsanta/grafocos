...
{
    public partial class FiltroMaestroTerceros : System.Web.UI.Page
    {
        ...
        private void Page_Load(object sender, System.EventArgs e)
        {
            ...
            else
            {
                ...
                Session["IdSuceso"] = Servipunto.Auditoria.Libreria.Sucesos.Adicionar(Servipunto.Estacion.Libreria.Aplicacion.Conexion, 205, ((Libreria.Usuario)Session["Usuario"]).IdUsuario.ToString(), "U").ToString();
        ...
        private bool VerificarPermisos()
        {
            ...
            permiso = ((Libreria.Usuario)Session["Usuario"]).Permisos.Verificar(modulo, opcion, "Generacion Archivo Maestro Terceros");
        ...
        private void EjecutarSP()
        {
            ...
            try
            {
                Session["IdSuceso"] = Servipunto.Auditoria.Libreria.Sucesos.Adicionar(Servipunto.Estacion.Libreria.Aplicacion.Conexion, 206, ((Libreria.Usuario)Session["Usuario"]).IdUsuario.ToString(), "U").ToString();
                ...
                resultado = objInterfazContables.PlanoTercerosEstandar("MT-" + Convert.ToDateTime(txtFechaInicial.Text).ToString("dd-MM-yyyy") + "_y_" + Convert.ToDateTime(txtFechaFin.Text).ToString("dd-MM-yyyy") + ".txt",
                    "c:\\TemporalPlanos",
        ...
        {
            #region traduccion
            this.lblReporte.Text = "<b>" + Servipunto.Estacion.Libreria.Configuracion.PalabrasIdioma.Traduccion(879, Global.Idioma)+"</b>";
            ...
            Label3.Text = Servipunto.Estacion.Libreria.Configuracion.PalabrasIdioma.Traduccion(2130, Global.Idioma);
