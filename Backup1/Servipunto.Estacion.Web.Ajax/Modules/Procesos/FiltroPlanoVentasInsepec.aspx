<%@ Page Language="C#" AutoEventWireup="true" Codebehind="FiltroPlanoVentasInsepec.aspx.cs"
    Inherits="Servipunto.Estacion.Web.Modules.Procesos.FiltroPlanoVentasInsepec"
                        ...
                        <tr>
                            ...
                            <td style="width: 210px">
                                <asp:RadioButtonList ID="rbtTipo" runat="server" Height="1px" RepeatDirection="Horizontal"
                                    Width="214px">
                                    <asp:ListItem Selected="True">Detallado</asp:ListItem>
