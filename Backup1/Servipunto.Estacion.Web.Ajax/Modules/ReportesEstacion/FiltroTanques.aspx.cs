...
{
	/// <summary>
	/// Descripción breve de FiltroTanques.
	/// </summary>
	public class FiltroTanques : System.Web.UI.Page
	{
		...
		protected System.Web.UI.WebControls.DropDownList cboTanques;
		protected System.Web.UI.WebControls.RadioButtonList rbFormato;
		protected System.Web.UI.WebControls.RadioButtonList rbTipoReporte;
		...
		{
            #region traduccion
            this.lblReporte.Text = "<b>" + Servipunto.Estacion.Libreria.Configuracion.PalabrasIdioma.Traduccion(22, Global.Idioma) + "</b>";
            Label1.Text = Servipunto.Estacion.Libreria.Configuracion.PalabrasIdioma.Traduccion(81, Global.Idioma);
            ...
            this.rbTipoReporte.Items.Clear();
            this.rbTipoReporte.Items.Insert(0, new ListItem(Servipunto.Estacion.Libreria.Configuracion.PalabrasIdioma.Traduccion(87, Global.Idioma), "variacion"));
            this.rbTipoReporte.Items.Insert(0, new ListItem(Servipunto.Estacion.Libreria.Configuracion.PalabrasIdioma.Traduccion(88, Global.Idioma), "balance"));
            this.rbTipoReporte.SelectedValue = "variacion";
            #endregion
            ViewState["Control"] = "1";
            #endregion            
			//this.lblReporte.Text = "<b>Reporte de Variación de Tanques</b>";
		...
		#region Cargar Tanques
		private void CargarTanques()
		{

			Servipunto.Estacion.Libreria.Configuracion.Tanques.Tanques objTanques = new Servipunto.Estacion.Libreria.Configuracion.Tanques.Tanques();
			
			this.cboTanques.DataSource = objTanques;
			this.cboTanques.DataTextField = "CodigoTanque";
			this.cboTanques.DataValueField = "CodigoTanque";
			this.cboTanques.DataBind();

            this.cboTanques.Items.Insert(0, new ListItem(Servipunto.Estacion.Libreria.Configuracion.PalabrasIdioma.Traduccion(82, Global.Idioma), "-1")); 
		...
		private void CargarArticulos()
		{
            ...
            this.ddlArticulo.Items.Insert(0, new ListItem(Servipunto.Estacion.Libreria.Configuracion.PalabrasIdioma.Traduccion(82, Global.Idioma), "-1")); 
		...
		private bool VerificarPermisos()
		{
			...
			permiso = ((Libreria.Usuario)Session["Usuario"]).Permisos.Verificar(modulo, opcion, "VariacionOBalance");
		...
		private void EjecutarReporte()
		{
			if (this.Validar())
			{
				...
				{
					int idtanque;
					Session["IdSuceso"] = Servipunto.Auditoria.Libreria.Sucesos.Adicionar(Servipunto.Estacion.Libreria.Aplicacion.Conexion ,326, ((Libreria.Usuario)Session["Usuario"]).IdUsuario.ToString(), "U").ToString();
					idtanque = int.Parse(cboTanques.SelectedValue);
					DataDynamics.ActiveReports.ActiveReport report = null;
					if(rbTipoReporte.SelectedValue == "variacion")
                        report = new Servipunto.Estacion.Web.Modules.Rpt.Tanque(Convert.ToDateTime(txtFechaInicial.Text), Convert.ToDateTime(txtFechaFin.Text), idtanque, Int16.Parse(ddlArticulo.SelectedValue));					
					else
                        report = new Servipunto.Estacion.Web.Modules.Rpt.Balance(Convert.ToDateTime(txtFechaInicial.Text), Convert.ToDateTime(txtFechaFin.Text), idtanque, Int16.Parse(ddlArticulo.SelectedValue));	
