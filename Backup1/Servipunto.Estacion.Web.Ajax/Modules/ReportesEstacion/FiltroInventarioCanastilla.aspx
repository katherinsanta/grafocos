<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FiltroInventarioCanastilla.aspx.cs" Inherits="Servipunto.Estacion.Web.Ajax.Modules.ReportesEstacion.FiltroInventarioCanastilla" 
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContenidoMaestro1" runat="server">
    ...
    <asp:Panel ID="pnlForm" Visible="true" runat="server">
        <table cellspacing="1" cellpadding="5" width="650" align="center" bgcolor="#5482fc"
            ...
            <tr>
                <td bgcolor="#eeeeee">
                    <asp:Label ID="lblReporte" runat="server">Reporte Inventario Canastilla</asp:Label></td>
            </tr>
            <tr>
                <td bgcolor="#fefbff">
                    ...
                    <table cellspacing="1" cellpadding="5" width="100%" border="0">
                        <tr>
                            ...
                            <asp:Label ID="lblArticulo" runat="server">
                                Articulo:
                            </asp:Label></td>
                            <td style="width: 154px">
                                <asp:DropDownList ID="ddlArticulos" runat="server" Enabled="False" Width="199px">
                                </asp:DropDownList></td>
                            <td style="width: 82px" valign="top">
                                <asp:CheckBox ID="chkTodos" runat="server" AutoPostBack="True" Checked="True" OnCheckedChanged="chkTodos_CheckedChanged"
                                    Text="Todos" /></td>
                            <td>
                            </td>
                        </tr>
