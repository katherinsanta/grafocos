<%@ Page Language="c#" Codebehind="FiltroHoraArticulo.aspx.cs" AutoEventWireup="true"
    Inherits="Servipunto.Estacion.Web.Modules.ReportesEstacion.FiltroHoraArticulo"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContenidoMaestro1" runat="server">
    ...
    <asp:Panel ID="pnlForm" Visible="true" runat="server">
        <table width="650" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#5482fc">
            <tr>
                <td bgcolor="#eeeeee">
                    <asp:Label ID="lblReporte" runat="server"> Reporte de Ventas por Hora del Día Laboral y Articulo</asp:Label>
                </td>
            </tr>
            <tr>
                <td bgcolor="#fefbff">
                    ...
                    <table width="100%" cellpadding="5" cellspacing="1" border="0">
                        ...
                        <tr>
                            ...
                            <td style="height: 43px">
                                <asp:DropDownList ID="cboArticulos" runat="server" Width="169px">
