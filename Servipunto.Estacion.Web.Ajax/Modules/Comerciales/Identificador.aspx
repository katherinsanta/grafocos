<%@ Page Language="c#" Codebehind="Identificador.aspx.cs" AutoEventWireup="true"
    Inherits="Servipunto.Estacion.Web.Modules.Comerciales.Identificador" ValidateRequest="false"
                                                        ...
                                                        <table cellpadding="4" border="0">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:DropDownList ID="ddlTipoIdentificador" runat="server" Width="120px">
                                                                        <asp:ListItem Value="Magnetica">Magnética</asp:ListItem>
                                                                        <asp:ListItem Value="Boton">Bot&#243;n</asp:ListItem>
                                                                    </asp:DropDownList></td>
                                                            </tr>
                                                            <tr id="filaPlaca" runat="server">
                                                                <td>
                                                                    <asp:Label ID="Label6" runat="server" Text="Placa"></asp:Label>:</td>
                                                                <td>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    ...
                                                                    <asp:Label ID="lblHidePlaca" runat="server" Visible="False"></asp:Label></td>
                                                                <td>
