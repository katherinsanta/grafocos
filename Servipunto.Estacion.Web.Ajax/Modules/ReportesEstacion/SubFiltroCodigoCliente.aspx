<%@ Page language="c#" Codebehind="SubFiltroCodigoCliente.aspx.cs" AutoEventWireup="false" 
Inherits="Servipunto.Estacion.Reportes.SubFiltroCodigoCliente" %>
...
<HTML>
	...
	<body bottomMargin="0" bgColor="#ffffff" leftMargin="0" topMargin="0" rightMargin="0">
		...
		<form id="MyForm" action="SubFiltroCodigoCliente.aspx" method="post" runat="server">
			<table cellSpacing="1" cellPadding="5" width="90%" align="center" bgColor="#5482fc" border="0">
				<tr>
					<td bgColor="#eeeeee"><asp:label id="lblReporte" runat="server">Filtro Cliente</asp:label></td>
				</tr>
				<tr>
					<td bgColor="#fefbff">
								...
								<TD style="WIDTH: 80%; HEIGHT: 33px" vAlign="top">
									<table class="ResultsTable" cellSpacing="1" cellPadding="5" width="100%" border="0">
										...
										<asp:Repeater id="Results" runat="server">
											<HeaderTemplate>
											<tr>
													<td class="ResultsHeader2" vAlign="middle">Cédula</td>
													<td class="ResultsHeader2" vAlign="middle" colspan=2>Nombre del Cliente</td>
											</tr>
											</HeaderTemplate>
											<ItemTemplate>
												<tr onclick = "javascript:SeleccionarItem('<%# DataBinder.Eval(Container.DataItem, "IdCliente")%>','txtCodigoCliente');">
													<td class="RowItem" vAlign="middle"><%# DataBinder.Eval(Container.DataItem, "IdCliente") %>	</td>
