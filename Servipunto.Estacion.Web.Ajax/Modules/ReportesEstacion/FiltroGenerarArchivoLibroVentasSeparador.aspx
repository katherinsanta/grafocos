<%@ Page language="c#" Codebehind="FiltroGenerarArchivoLibroVentasSeparador.aspx.cs"
 AutoEventWireup="false" Inherits="Servipunto.Estacion.Reportes.FiltroGenerarArchivoLibroVentasSeparador" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>Exportar Tabla de Ventas a un Archivo Plano</title>
	...
	<body bottomMargin="0" bgColor="#ffffff" leftMargin="0" topMargin="0" rightMargin="0">
		...
		<form id="MyForm" action="FiltroGenerarArchivoLibroVentasSeparador.aspx" method="post"
			...
			<table cellSpacing="1" cellPadding="5" width="650" align="center" bgColor="#5482fc" border="0">
				<tr>
					<td bgColor="#eeeeee"><asp:label id="lblReporte" runat="server"> Exportar Tabla de Ventas a un Archivo Plano</asp:label></td>
				</tr>
				<tr>
					<td bgColor="#fefbff">
