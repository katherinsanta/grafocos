...
{
    public partial class FiltrosExtractos : System.Web.UI.Page
    {
        ...
        private void EjecutarReporte()
        {
            if (this.Validar())
            {
                try
                {
                    ...
                    DataDynamics.ActiveReports.ActiveReport3 report = null;
                    switch (this.ddlNivelDetalle.SelectedValue)
                    {
                        case "0":
                            report = new Servipunto.Estacion.Web.Modules.Rpt.ExtractoClienteDetalleBajo(Convert.ToDateTime(txtFechaInicial.Text), Convert.ToDateTime(txtFechaFin.Text), Convert.ToInt32(this.ddlFormaPago.SelectedValue), this.txtAutomotor.Text, this.cbTodosAutomotores.Checked, this.txtCodigoCliente.Text, this.cbTodos.Checked);
                            break;

                        case "1":
                            report = new Servipunto.Estacion.Web.Modules.Rpt.ExtractoClienteDetalleMedio(Convert.ToDateTime(txtFechaInicial.Text), Convert.ToDateTime(txtFechaFin.Text), Convert.ToInt32(this.ddlFormaPago.SelectedValue), this.txtAutomotor.Text, this.cbTodosAutomotores.Checked, this.txtCodigoCliente.Text, this.cbTodos.Checked);
                            break;

                        case "2":
                            report = new Servipunto.Estacion.Web.Modules.Rpt.ExtractoClienteValor(Convert.ToDateTime(txtFechaInicial.Text), Convert.ToDateTime(txtFechaFin.Text), Convert.ToInt32(this.ddlFormaPago.SelectedValue), this.txtAutomotor.Text, this.cbTodosAutomotores.Checked, this.txtCodigoCliente.Text, this.cbTodos.Checked);
                            break;

                        case "3":
                            report = new Servipunto.Estacion.Web.Modules.Rpt.ExtractoClienteClasico(Convert.ToDateTime(txtFechaInicial.Text), Convert.ToDateTime(txtFechaFin.Text), Convert.ToInt32(this.ddlFormaPago.SelectedValue), this.txtAutomotor.Text, this.cbTodosAutomotores.Checked, this.txtCodigoCliente.Text, this.cbTodos.Checked);
                            break;
                    }
        ...
        private void InicializarForma()
        {
            ...
            this.ddlNivelDetalle.Items.Insert(0, new ListItem(Servipunto.Estacion.Libreria.Configuracion.PalabrasIdioma.Traduccion(373, Global.Idioma), "0"));
            this.ddlNivelDetalle.Items.Insert(0, new ListItem(Servipunto.Estacion.Libreria.Configuracion.PalabrasIdioma.Traduccion(374, Global.Idioma), "1"));
            this.ddlNivelDetalle.Items.Insert(0, new ListItem(Servipunto.Estacion.Libreria.Configuracion.PalabrasIdioma.Traduccion(375, Global.Idioma), "2"));
            this.ddlNivelDetalle.Items.Insert(0, new ListItem(Servipunto.Estacion.Libreria.Configuracion.PalabrasIdioma.Traduccion(376, Global.Idioma), "3"));
