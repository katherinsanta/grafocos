<%@ Page Language="C#" AutoEventWireup="true" Codebehind="FiltroCalibración.aspx.cs"
    Inherits="Servipunto.Estacion.Web.Modules.ReportesEstacion.FiltroCalibración"
                    ...
                    <table cellspacing="1" cellpadding="5" width="100%" border="0">
                        <tr>
                            ...
                            <td style="width: 137px; height: 22px">
                                <asp:RadioButtonList ID="TipoReporte" runat="server" Width="200px" OnSelectedIndexChanged="TipoReporte_SelectedIndexChanged">
                                    <asp:ListItem Value="1" Selected="True">Turno</asp:ListItem>
                        ...
                        <tr>
                            ...
                            <td style="width: 137px">
                                <asp:DropDownList ID="cboArticulo" runat="server" DataTextField="Descripcion" DataValueField="Codigo"
                                    Width="160px">
                                </asp:DropDownList></td>
                            <td style="width: 84px" valign="top">
                            </td>
