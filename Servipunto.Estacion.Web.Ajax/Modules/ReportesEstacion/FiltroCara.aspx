<%@ Page Language="c#" Codebehind="FiltroCara.aspx.cs" AutoEventWireup="true" Inherits="Servipunto.Estacion.Reportes.FiltroCara"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContenidoMaestro1" runat="server">
    ...
    <asp:Panel ID="pnlForm" Visible="true" runat="server">
        <table cellspacing="1" cellpadding="5" width="650" align="center" bgcolor="#5482fc"
            ...
            <tr>
                <td bgcolor="#eeeeee">
                    <asp:Label ID="lblReporte" runat="server">Reporte de Ventas por Cara</asp:Label></td>
            </tr>
            <tr>
                <td bgcolor="#fefbff">
                    ...
                    <table cellspacing="1" cellpadding="5" width="100%" border="0">
                        <tr>
                            <td valign="top">
                                <asp:Label ID="Label1" runat="server" Text="Cara"></asp:Label>:</td>
                            <td>
                                <asp:DropDownList ID="ddlCara" runat="server" Width="182px">
                                </asp:DropDownList></td>
                            <td valign="top">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:Calendar ID="FechaFin" runat="server" BackColor="White" BorderColor="#999999"
                                    ...
                                    Visible="false" ForeColor="Black" Height="180px" Width="200px">
                                    <SelectedDayStyle BackColor="#666666" Font-Bold="True" ForeColor="White" />
                                    <SelectorStyle BackColor="#CCCCCC" />
                                    <WeekendDayStyle BackColor="#FFFFCC" />
                                    <TodayDayStyle BackColor="#CCCCCC" ForeColor="Black" />
