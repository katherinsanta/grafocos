<%@ Page Language="c#" Codebehind="FiltroHoraDia.aspx.cs" AutoEventWireup="true"
    Inherits="Servipunto.Estacion.Reportes.FiltroHoraDia" MasterPageFile="~/PaginaMaestra/actualizacion.Master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContenidoMaestro1" runat="server">
    ...
    <asp:Panel ID="pnlForm" Visible="true" runat="server">
        <table width="650" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#5482fc">
            <tr>
                <td bgcolor="#eeeeee">
                    <asp:Label ID="lblReporte" runat="server"> Reporte de Ventas por Hora del Día Laboral</asp:Label>
                </td>
            </tr>
            <tr>
                <td bgcolor="#fefbff">
