...
{
    public partial class FiltroPlanosSyscon : System.Web.UI.Page
    {
        ...
        {
            #region traduccion
            this.lblReporte.Text = "<b>" + Servipunto.Estacion.Libreria.Configuracion.PalabrasIdioma.Traduccion(942, Global.Idioma) + "</b>";
            ...
            Label3.Text = Servipunto.Estacion.Libreria.Configuracion.PalabrasIdioma.Traduccion(400, Global.Idioma);
            ...
            #region poblar RadioButton  rbtArchivo
            this.rbtArchivo.Items.Clear();
            this.rbtArchivo.Items.Insert(0, new ListItem(Servipunto.Estacion.Libreria.Configuracion.PalabrasIdioma.Traduccion(564, Global.Idioma), "Lecturas"));
            this.rbtArchivo.Items.Insert(0, new ListItem(Servipunto.Estacion.Libreria.Configuracion.PalabrasIdioma.Traduccion(844, Global.Idioma), "Ventas"));
            this.rbtArchivo.SelectedValue = "Lecturas";
            #endregion
            #endregion
        ...
        private bool VerificarPermisos()
        {
            ...
            permiso = ((Libreria.Usuario)Session["Usuario"]).Permisos.Verificar(modulo, opcion, "PlanoLecturasVentas");
        ...
        private void EjecutarExportar()
        {
            ...
            try
            {
                ...
                if (rbtArchivo.SelectedValue == "Lecturas")
                {
                    resultado = objInterfazContables.PlanoLecturas(
                        "C:\\Servipunto\\Planos\\TemporalPlanos",
                        Convert.ToDateTime(txtFechaInicial.Text),
                        int.Parse(txtTurno.Text.Trim()), txtCodigoIsla.Text  
                        );
                ...
                else
                {
                    ...
                    resultado = objInterfazContables.PlanoVentas(
                        "C:\\Servipunto\\Planos\\TemporalPlanos",
                        Convert.ToDateTime(txtFechaInicial.Text),
                        int.Parse(txtTurno.Text.Trim()),"AS400", txtCodigoIsla.Text
                        );
