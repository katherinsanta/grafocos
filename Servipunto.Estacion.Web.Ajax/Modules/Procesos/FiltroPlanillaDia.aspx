<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FiltroPlanillaDia.aspx.cs"
    Inherits="Servipunto.Estacion.Web.Ajax.Modules.Procesos.FiltroPlanillaDia" MasterPageFile="~/PaginaMaestra/actualizacion.Master" %>
                                ...
                                <td>
                                    <div align="right">
                                        <asp:LinkButton ID="lnkGenerar" runat="server" Text="Generar" 
                                            onclick="btnGenerar_Click"></asp:LinkButton>
