<%@ Page Language="C#" AutoEventWireup="true" Codebehind="FiltroTrasladosSAP.aspx.cs"
    Inherits="Servipunto.Estacion.Web.Modules.Procesos.FiltroTrasladosSAP"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContenidoMaestro1" runat="server">
    ...
    <asp:Panel ID="pnlForm" Visible="true" runat="server">
        <table cellspacing="1" cellpadding="5" align="center" bgcolor="#5482fc" border="0">
            <tr>
                <td bgcolor="#eeeeee">
                    <asp:Label ID="lblReporte" runat="server">Generar Archivo Plano de Traslados para SAP</asp:Label></td>
            </tr>
            <tr>
                <td bgcolor="#fefbff">
