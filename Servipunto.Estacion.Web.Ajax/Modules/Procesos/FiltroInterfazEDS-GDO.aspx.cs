...
{
    public partial class FiltroInterfazEDS_GDO : System.Web.UI.Page
    {
		...
		{
            #region traduccion
            this.lblReporte.Text = "<b>" + Servipunto.Estacion.Libreria.Configuracion.PalabrasIdioma.Traduccion(2165, Global.Idioma) + "</b>";
		...
		private void lblEnviaRecaudoGDO_Click(object sender, System.EventArgs e)
		{
			...
			try 
			{
				...
				resultado = Servipunto.Estacion.Libreria.Planos.InterfazContables.PlanoRecaudosGDO(this.FechaInicio.SelectedDate);
				if(resultado != "OK")
				{
