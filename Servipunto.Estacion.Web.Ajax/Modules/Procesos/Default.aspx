                                        ...
                                        <table cellspacing="5" cellpadding="10" align="center" border="0">
                                            <tr>
                                                ...
                                                <td valign="top" align="left" style="height: 52px; margin: 0px;" width="128px">
                                                    ...
                                                    <p class="Descripcion">
                                                        Actualice Tablas A partir DeArchivos Planos</p>
                                                </td>
                                                <!--INTERFAZ CONTABLE -->
                                                <td valign="top" align="center" style="margin: 0px; height: 52px" width="48px">
                                                ...
                                                <td valign="top" align="left" style="height: 52px; margin: 0px;" width="128px">
                                                    ...
                                                    <p class="Descripcion">
                                                        Genere Archivos pLanos Contables</p>
                                                </td>
                                                ...
                                                </td>--%><!--AJUSTE PREPAGOS --><td valign="top" align="center" style="margin: 0px;
                                                ...
                                                <td valign="top" align="left" style="height: 52px; margin: 0px;" width="128px">
                                                    <a href="RegistroOtrosIngresos.aspx">Otros Ingresos </a>
                                                    <p class="Descripcion">
                                                        Cree Modifique o Elimine Otros Ingresos</p>
                                                </td>
                                                ...
                                                <td valign="top" align="left" style="height: 52px; margin: 0px;" width="148px">
                                                    ...
                                                    <p class="Descripcion">
                                                        Actualice Los Registros De Canastilla
                                                    </p>
                                                </td>
                                            </tr>
