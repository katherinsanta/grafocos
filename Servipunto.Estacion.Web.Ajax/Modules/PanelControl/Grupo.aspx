<%@ Page Language="c#" Codebehind="Grupo.aspx.cs" AutoEventWireup="false" Inherits="Servipunto.Estacion.Web.Modules.PanelControl.Grupo"
                                                    ...
                                                    <td class="ResultsItem" valign="middle" align="left">
                                                        <table cellpadding="4" border="0">
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="txtCodigo" Width="112px" MaxLength="5" runat="server"></asp:TextBox></td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <asp:Label ID="Label2" runat="server" Text="Nombre"></asp:Label>:</td>
                                                                <td>
                                                                    <asp:TextBox ID="txtNombre" runat="server" MaxLength="60" Width="312px"></asp:TextBox>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="txtDescripcion" runat="server" MaxLength="60" Width="464px"></asp:TextBox></td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    &nbsp;</td>
                                                                <td>
                                                                    ...
                                                                    <input visible="false" class="Button" id="AcceptButton" type="submit" value="Crear"
