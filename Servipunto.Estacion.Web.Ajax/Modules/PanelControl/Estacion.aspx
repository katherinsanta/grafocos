<%@ Page Language="c#" Codebehind="Estacion.aspx.cs" AutoEventWireup="false" Inherits="Servipunto.Estacion.Web.Modules.PanelControl.Estacion"
                                                    ...
                                                    <td class="ResultsItem" valign="middle" align="left">
                                                        <table cellpadding="4" border="0">
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="txtCodigo" Width="112px" MaxLength="5" runat="server"></asp:TextBox>
