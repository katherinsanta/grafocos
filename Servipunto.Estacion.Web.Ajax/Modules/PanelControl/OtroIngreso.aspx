<%@ Page Language="C#" AutoEventWireup="true" Codebehind="OtroIngreso.aspx.cs" Inherits="Servipunto.Estacion.Web.Modules.PanelControl.OtroIngreso"
                                                    ...
                                                    <td class="ResultsItem" valign="middle" align="left">
                                                        <table cellpadding="4" border="0">
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="txtCodigo" Width="112px" MaxLength="5" runat="server" Visible="false"></asp:TextBox></td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    Nombre de Otro Ingreso:</td>
                                                                <td>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    &nbsp;</td>
                                                                <td>
                                                                    <asp:Button ID="Button1" runat="server" Height="24px" OnClick="Button1_Click" Text="Crear"
                                                                        Width="64px" />
