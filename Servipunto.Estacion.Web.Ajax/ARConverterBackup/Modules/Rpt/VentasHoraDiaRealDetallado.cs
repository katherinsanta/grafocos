...
namespace Servipunto.Estacion.Web.Modules.Rpt
{
    ...
    /// </summary>
    public partial class VentasHoraDiaRealDetallado : DataDynamics.ActiveReports.ActiveReport3
    {
        ...
        public VentasHoraDiaRealDetallado(DateTime fechaInicio, DateTime fechaFin, int hora)
        {
        ...
        {
            lbl.Text = Servipunto.Estacion.Libreria.Configuracion.PalabrasIdioma.Traduccion(2276, Global.Idioma);
        ...
        {
            this.LoadLayout(this.GetType(), "Servipunto.Estacion.Web.Modules.Rpt.VentasHoraDiaRealDetallado.rpx");
