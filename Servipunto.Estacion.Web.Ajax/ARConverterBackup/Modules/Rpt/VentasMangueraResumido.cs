...
{
    /// <summary>
    /// Summary description for VentasMangueraResumido.
    /// </summary>
    public partial class VentasMangueraResumido : DataDynamics.ActiveReports.ActiveReport3
    {
        ...
        public VentasMangueraResumido(DateTime fechaInicio, DateTime fechaFin, int manguera)
        {
        ...
        {
            Label15.Text = Servipunto.Estacion.Libreria.Configuracion.PalabrasIdioma.Traduccion(2283, Global.Idioma);
            lblManguera.Text = Servipunto.Estacion.Libreria.Configuracion.PalabrasIdioma.Traduccion(44, Global.Idioma);
            lblAtendidos.Text = Servipunto.Estacion.Libreria.Configuracion.PalabrasIdioma.Traduccion(2284, Global.Idioma);            
        ...
        {
            this.srptGrafica.Report = new SubGraficaVentasPorManguera();
            ...
            ((SubGraficaVentasPorManguera)this.srptGrafica.Report).RefrescarGrafica();
        }
        #endregion
        ...
        {
            this.LoadLayout(this.GetType(), "Servipunto.Estacion.Web.Modules.Rpt.VentasMangueraResumido.rpx");
            ...
            this.lblAtendidos = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[2]));
            ...
            this.txtAtendidos = ((DataDynamics.ActiveReports.TextBox)(this.Detail.Controls[5]));
            ...
            this.TextBox1 = ((DataDynamics.ActiveReports.TextBox)(this.gfTotal.Controls[8]));
