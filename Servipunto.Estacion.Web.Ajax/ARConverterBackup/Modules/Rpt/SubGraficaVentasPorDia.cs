...
namespace Servipunto.Estacion.Web.Modules.Rpt
{
    ...
    /// </summary>
    public partial class SubGraficaVentasPorDia : DataDynamics.ActiveReports.ActiveReport3
    {

        #region	Constructor de la Clase
        public SubGraficaVentasPorDia()
        {
            InitializeComponent();
        }
        #endregion
        ...
        {
            this.LoadLayout(this.GetType(), "Servipunto.Estacion.Web.Modules.Rpt.SubGraficaVentasPorDia.rpx");
