...
namespace Servipunto.Estacion.Web.Modules.Rpt
{
    ...
    /// </summary>
    public partial class VentasClientesPorCodigoDetallado : DataDynamics.ActiveReports.ActiveReport3
    {
        ...
        public VentasClientesPorCodigoDetallado(DateTime fechaInicio, DateTime fechaFin, string codigo, bool todos, int nit)
        {
        ...
        {
            Label15.Text = Servipunto.Estacion.Libreria.Configuracion.PalabrasIdioma.Traduccion(2262, Global.Idioma);
        ...
        {
            this.LoadLayout(this.GetType(), "Servipunto.Estacion.Web.Modules.Rpt.VentasClientesPorCodigoDetallado.rpx");
