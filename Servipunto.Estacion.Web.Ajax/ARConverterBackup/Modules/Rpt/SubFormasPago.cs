...
namespace Servipunto.Estacion.Web.Modules.Rpt
{
    ...
    /// </summary>
    public partial class SubFormasPago : DataDynamics.ActiveReports.ActiveReport3
    {

        public SubFormasPago()
        {
            InitializeComponent();
            Traducir();
        }
        ...
        private void Traducir()
        {
            ...
            Label3.Text = Servipunto.Estacion.Libreria.Configuracion.PalabrasIdioma.Traduccion(2366, Global.Idioma);
         
        }
        #endregion
        public void InitializeReport()
        {
            this.LoadLayout(this.GetType(), "Servipunto.Estacion.Web.Modules.Rpt.SubFormasPago.rpx");
            ...
            this.Label3 = ((DataDynamics.ActiveReports.Label)(this.gfPagos.Controls[10]));
        }
