...
namespace Servipunto.Estacion.Web.Modules.Rpt
{
    ...
    /// </summary>
    public partial class SubGraficaTurno : DataDynamics.ActiveReports.ActiveReport3
    {

        #region Constructor de la clase
        public SubGraficaTurno()
        {
            InitializeComponent();
        }
        ...
        {
            this.LoadLayout(this.GetType(), "Servipunto.Estacion.Web.Modules.Rpt.SubGraficaTurno.rpx");
