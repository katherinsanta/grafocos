...
namespace Servipunto.Estacion.Web.Modules.Rpt
{
    ...
    /// </summary>
    public partial class VentasDiaSemanaResumido : DataDynamics.ActiveReports.ActiveReport3
    {
        ...
        public VentasDiaSemanaResumido(DateTime fechaInicio, DateTime fechaFin, int dia)
        {
        ...
        {
            lbl.Text = Servipunto.Estacion.Libreria.Configuracion.PalabrasIdioma.Traduccion(2268, Global.Idioma);
            lblDia.Text = Servipunto.Estacion.Libreria.Configuracion.PalabrasIdioma.Traduccion(2046, Global.Idioma);            
        ...
        {
            this.srptGrafica.Report = new SubGraficaVentasPorDia();
            ...
            ((SubGraficaVentasPorDia)this.srptGrafica.Report).RefrescarGrafica();
        }
        #endregion
        public void InitializeReport()
        {
            this.LoadLayout(this.GetType(), "Servipunto.Estacion.Web.Modules.Rpt.VentasDiaSemanaResumido.rpx");
            ...
            this.lblDia = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[12]));
            ...
            this.txtDia = ((DataDynamics.ActiveReports.TextBox)(this.Detail.Controls[5]));
            ...
            this.TextBox8 = ((DataDynamics.ActiveReports.TextBox)(this.gfTotal.Controls[8]));
