...
{
    /// <summary>
    /// Summary description for HistorialLibroVentasDetallado.
    /// </summary>
    public partial class HistorialLibroVentasDetallado : DataDynamics.ActiveReports.ActiveReport3
    {
        ...
        public HistorialLibroVentasDetallado(DateTime fechaInicio, DateTime fechaFin, bool todas, string nombreArchivo)
        {
            _todas = todas;
        ...
        private void Traducir()
        {
            ...
            lblFechaCreacion.Text = Servipunto.Estacion.Libreria.Configuracion.PalabrasIdioma.Traduccion(231, Global.Idioma);
        ...
        {
            this.LoadLayout(this.GetType(), "Servipunto.Estacion.Web.Modules.Rpt.HistorialLibroVentasDetallado.rpx");
            ...
            this.lblFechaCreacion = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[6]));
