...
namespace Servipunto.Estacion.Web.Modules.Rpt
{
    ...
    /// </summary>
    public partial class AuditoriaUsuarioTablas : DataDynamics.ActiveReports.ActiveReport3
    {
        ...
        {
            Label.Text = Servipunto.Estacion.Libreria.Configuracion.PalabrasIdioma.Traduccion(2191, Global.Idioma);
            ...
            Label9.Text = Servipunto.Estacion.Libreria.Configuracion.PalabrasIdioma.Traduccion(449, Global.Idioma);
            Label10.Text = Servipunto.Estacion.Libreria.Configuracion.PalabrasIdioma.Traduccion(447, Global.Idioma);
		...
		{
			this.LoadLayout(this.GetType(), "Servipunto.Estacion.Web.Modules.Rpt.AuditoriaUsuarioTablas.rpx");
			...
			this.txtDescripcionAfectados = ((DataDynamics.ActiveReports.TextBox)(this.Detail.Controls[8]));
			this.lblDetalle = ((DataDynamics.ActiveReports.Label)(this.Detail.Controls[9]));
