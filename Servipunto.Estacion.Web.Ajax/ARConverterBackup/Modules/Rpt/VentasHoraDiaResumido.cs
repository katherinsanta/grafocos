...
namespace Servipunto.Estacion.Web.Modules.Rpt
{
    ...
    /// </summary>
    public partial class VentasHoraDiaResumido : DataDynamics.ActiveReports.ActiveReport3
    {
        ...
        public VentasHoraDiaResumido(DateTime fechaInicio, DateTime fechaFin, int hora)
        {
        ...
        {
            lbl.Text = Servipunto.Estacion.Libreria.Configuracion.PalabrasIdioma.Traduccion(2278, Global.Idioma);
        ...
        {
            this.LoadLayout(this.GetType(), "Servipunto.Estacion.Web.Modules.Rpt.VentasHoraDiaResumido.rpx");
