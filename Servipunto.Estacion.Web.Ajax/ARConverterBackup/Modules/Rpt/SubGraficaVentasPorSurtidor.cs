...
namespace Servipunto.Estacion.Web.Modules.Rpt
{
    ...
    /// </summary>
    public partial class SubGraficaVentasPorSurtidor : DataDynamics.ActiveReports.ActiveReport3
    {

        #region Constructor de la Clase
        public SubGraficaVentasPorSurtidor()
        {
            InitializeComponent();
        }
        #endregion
        ...
        {
            this.LoadLayout(this.GetType(), "Servipunto.Estacion.Web.Modules.Rpt.SubGraficaVentasPorSurtidor.rpx");
