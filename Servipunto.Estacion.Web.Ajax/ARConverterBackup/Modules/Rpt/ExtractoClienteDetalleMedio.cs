...
namespace Servipunto.Estacion.Web.Modules.Rpt
{
    ...
    /// </summary>
    public partial class ExtractoClienteDetalleMedio : DataDynamics.ActiveReports.ActiveReport3
    {
        ...
        public ExtractoClienteDetalleMedio(DateTime fechaInicio, DateTime fechaFin,  string horainicio, string horafinal, int formaPago, string codigoAutomotor, bool todosAutomotores, string codigoCliente, bool todosClientes)
        {
        ...
        {
            this.LoadLayout(this.GetType(), "Servipunto.Estacion.Web.Modules.Rpt.ExtractoClienteDetalleMedio.rpx");
            ...
            this.Line = ((DataDynamics.ActiveReports.Line)(this.ghCliente.Controls[7]));
            this.Line1 = ((DataDynamics.ActiveReports.Line)(this.ghCliente.Controls[8]));
            this.lblUnidades = ((DataDynamics.ActiveReports.Label)(this.ghCliente.Controls[9]));
            this.lblTotal = ((DataDynamics.ActiveReports.Label)(this.ghCliente.Controls[10]));
            this.lblKilometraje = ((DataDynamics.ActiveReports.Label)(this.ghCliente.Controls[11]));
            ...
            this.txtKilometraje = ((DataDynamics.ActiveReports.TextBox)(this.Detail.Controls[2]));
            this.txtTotalPlacaUnidades = ((DataDynamics.ActiveReports.TextBox)(this.gfTotal.Controls[0]));
            this.TotalPlacaTotal = ((DataDynamics.ActiveReports.TextBox)(this.gfTotal.Controls[1]));
            this.Label1 = ((DataDynamics.ActiveReports.Label)(this.gfTotal.Controls[2]));
