...
namespace Servipunto.Estacion.Web.Modules.Rpt
{
    ...
    /// </summary>
    public partial class VentasHoraDiaRealResumido : DataDynamics.ActiveReports.ActiveReport3
    {
        ...
        public VentasHoraDiaRealResumido(DateTime fechaInicio, DateTime fechaFin, int hora)
        {
        ...
        {
            lbl.Text = Servipunto.Estacion.Libreria.Configuracion.PalabrasIdioma.Traduccion(2277, Global.Idioma);
        ...
        private string QueryPrincipal()
        {
            ...
            sql.Append(" Exec SP_RptDayTimeReal");
        ...
        private void InitializeGraph()
        {
            ...
            ((SubGraficaVentasPorHora)this.srptGrafica.Report).RefrescarGrafica();
        }
        #endregion
        ...
        {
            this.LoadLayout(this.GetType(), "Servipunto.Estacion.Web.Modules.Rpt.VentasHoraDiaRealResumido.rpx");
