...
namespace Servipunto.Estacion.Web.Modules.Rpt
{
    ...
    /// </summary>
    public partial class InfoAutomotores : DataDynamics.ActiveReports.ActiveReport3
    {

        #region Constructor de la Clase
        public InfoAutomotores()
        {
            InitializeComponent();
            InitializeDatabase();
            Traducir();
        ...
        {
            Label15.Text = Servipunto.Estacion.Libreria.Configuracion.PalabrasIdioma.Traduccion(2222, Global.Idioma);
            ...
            lblIva.Text = Servipunto.Estacion.Libreria.Configuracion.PalabrasIdioma.Traduccion(1642, Global.Idioma);

            lblTotal.Text = Servipunto.Estacion.Libreria.Configuracion.PalabrasIdioma.Traduccion(858, Global.Idioma);
        ...
        {
            this.LoadLayout(this.GetType(), "Servipunto.Estacion.Web.Modules.Rpt.InfoAutomotores.rpx");
