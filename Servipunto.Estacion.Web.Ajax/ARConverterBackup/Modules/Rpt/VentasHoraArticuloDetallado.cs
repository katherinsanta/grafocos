...
{
    /// <summary>
    /// Summary description for VentasHoraArticuloDetallado.
    /// </summary>
    public partial class VentasHoraArticuloDetallado : DataDynamics.ActiveReports.ActiveReport3
    {
        ...
        public VentasHoraArticuloDetallado(DateTime fechaInicio, DateTime fechaFin, int hora, int codigoArticulo)
        {
        ...
        {
            lbl.Text = Servipunto.Estacion.Libreria.Configuracion.PalabrasIdioma.Traduccion(2274, Global.Idioma);
        ...
        private string QueryPrincipal()
        {
            ...
            sql.Append(" Exec HoraArticuloDetallado");
        ...
        {
            this.LoadLayout(this.GetType(), "Servipunto.Estacion.Web.Modules.Rpt.VentasHoraArticuloDetallado.rpx");
            ...
            this.lbl = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[0]));
            this.srptEncabezado = ((DataDynamics.ActiveReports.SubReport)(this.PageHeader.Controls[1]));
            this.lblFecha = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[2]));
            this.lblHora = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[3]));
            ...
            this.lblRecaudo = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[6]));
            this.lblIva = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[7]));
            this.lblSubTotal = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[8]));
            this.Label1 = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[9]));
            ...
            this.lbltituloHora = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[12]));
            ...
            this.Label = ((DataDynamics.ActiveReports.Label)(this.PageFooter.Controls[0]));
            this.lblPagina = ((DataDynamics.ActiveReports.Label)(this.PageFooter.Controls[1]));
            ...
            this.txtNumeroPaginas = ((DataDynamics.ActiveReports.TextBox)(this.PageFooter.Controls[4]));
