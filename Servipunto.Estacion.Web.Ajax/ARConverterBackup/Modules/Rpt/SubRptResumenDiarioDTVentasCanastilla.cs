...
namespace Servipunto.Estacion.Web.Modules.Rpt
{
    ...
    /// </summary>
    public partial class SubRptResumenDiarioDTVentasCanastilla : DataDynamics.ActiveReports.ActiveReport3
    {
        ...
        public SubRptResumenDiarioDTVentasCanastilla(DateTime fechaInicial, DateTime fechaFinal, int Idioma)
        {
        ...
        private string QueryPrincipal()
        {
            ...
            sql.Append("exec");
            sql.Append(" RptRDDVentasCanastilla");
