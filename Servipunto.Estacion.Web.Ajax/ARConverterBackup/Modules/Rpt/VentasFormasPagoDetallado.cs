...
{
    /// <summary>
    /// Summary description for VentasFormasPagoDetallado.
    /// </summary>
    public partial class VentasFormasPagoDetallado : DataDynamics.ActiveReports.ActiveReport3
    {
        ...
        public VentasFormasPagoDetallado(DateTime fechaInicio, DateTime fechaFin, int codigoArticulo, int formaPago, string codigoCliente, bool todos)
        {
        ...
        {
            Label15.Text = Servipunto.Estacion.Libreria.Configuracion.PalabrasIdioma.Traduccion(2269, Global.Idioma);
            lblConsecutivo.Text = Servipunto.Estacion.Libreria.Configuracion.PalabrasIdioma.Traduccion(390, Global.Idioma);
            Label2.Text = Servipunto.Estacion.Libreria.Configuracion.PalabrasIdioma.Traduccion(294, Global.Idioma);
            lblArticulo.Text = Servipunto.Estacion.Libreria.Configuracion.PalabrasIdioma.Traduccion(256, Global.Idioma);
            Label5.Text = Servipunto.Estacion.Libreria.Configuracion.PalabrasIdioma.Traduccion(1714, Global.Idioma);
            ...
            Label3.Text = Servipunto.Estacion.Libreria.Configuracion.PalabrasIdioma.Traduccion(2247, Global.Idioma);            
        ...
        {
            this.LoadLayout(this.GetType(), "Servipunto.Estacion.Web.Modules.Rpt.VentasFormasPagoDetallado.rpx");
            ...
            this.lblTotal = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[3]));
            ...
            this.Label5 = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[11]));
            this.lblTituloFecha = ((DataDynamics.ActiveReports.Label)(this.ghFecha.Controls[0]));
            ...
            this.TextBox2 = ((DataDynamics.ActiveReports.TextBox)(this.gfFecha.Controls[1]));
            this.TextBox10 = ((DataDynamics.ActiveReports.TextBox)(this.gfFecha.Controls[2]));
