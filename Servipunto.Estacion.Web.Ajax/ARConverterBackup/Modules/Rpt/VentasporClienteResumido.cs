...
namespace Servipunto.Estacion.Web.Modules.Rpt
{
    ...
    /// </summary>
    public partial class VentasporClienteResumido : DataDynamics.ActiveReports.ActiveReport3
    {
        ...
        public VentasporClienteResumido(DateTime fechaInicio, DateTime fechaFin, string codigoCliente, string placa)
        {
        ...
        {
            Label15.Text = Servipunto.Estacion.Libreria.Configuracion.PalabrasIdioma.Traduccion(2286, Global.Idioma);            
        ...
        {
            this.LoadLayout(this.GetType(), "Servipunto.Estacion.Web.Modules.Rpt.VentasporClienteResumido.rpx");
            ...
            this.lblAutomotor = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[13]));
