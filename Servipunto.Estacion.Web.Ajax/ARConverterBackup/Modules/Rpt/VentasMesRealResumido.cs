...
namespace Servipunto.Estacion.Web.Modules.Rpt
{
    ...
    /// </summary>
    public partial class VentasMesRealResumido : DataDynamics.ActiveReports.ActiveReport3
    {
        ...
        public VentasMesRealResumido(DateTime fechaInicio, DateTime fechaFin, int mes)
        {
            _mes = mes;
            _fechaInicio = DateTime.Parse(System.DateTime.Now.Year.ToString().PadLeft(4, '0') + "-" + this._mes.ToString().PadLeft(2, '0') + "-" + "01");
            _fechaFin = _fechaInicio;
            _fechaFin = _fechaFin.AddMonths(+1);
        ...
        {
            lbl.Text = Servipunto.Estacion.Libreria.Configuracion.PalabrasIdioma.Traduccion(2285, Global.Idioma);
            lbltituloHora.Text = Servipunto.Estacion.Libreria.Configuracion.PalabrasIdioma.Traduccion(243, Global.Idioma);            
        ...
        private string QueryGranTotal()
        {
            ...
            sql.Append(this._fechaInicio.ToString("yyyyMMdd") + ", ");
            sql.Append(this._fechaFin.ToString("yyyyMMdd") + ", 'H',");
            if(this._hora != 24)
                sql.Append(this._hora);
            else
            //sql.Append("24");
...
*/
            ...
            sql.Append(",@Fecha_Num_Mes = '" + this._mes.ToString() + "'");
            return sql.ToString();
        }
        #endregion
        ...
        {
            this.LoadLayout(this.GetType(), "Servipunto.Estacion.Web.Modules.Rpt.VentasMesRealResumido.rpx");
            ...
            this.lblCantidadVentas = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[13]));
            ...
            this.txtcntidadVentas = ((DataDynamics.ActiveReports.TextBox)(this.Detail.Controls[6]));
            ...
            this.srptGrafica = ((DataDynamics.ActiveReports.SubReport)(this.gfTotal.Controls[7]));
            this.txtTotalCantVentas = ((DataDynamics.ActiveReports.TextBox)(this.gfTotal.Controls[8]));
            this.TextBox1 = ((DataDynamics.ActiveReports.TextBox)(this.gfTotal.Controls[9]));
