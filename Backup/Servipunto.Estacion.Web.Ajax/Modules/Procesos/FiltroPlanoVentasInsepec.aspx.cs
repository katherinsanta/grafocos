...
{
    public partial class FiltroPlanoVentasInsepec : System.Web.UI.Page
    {
        ...
        private void EjecutarExportar()
        {
            ...
            try
            {
                ...
                if (rbtTipo.SelectedValue == Libreria.Configuracion.PalabrasIdioma.Traduccion(34, Global.Idioma))
                {
                    resultado = objInterfazContables.PlanoVentasInsepec(
