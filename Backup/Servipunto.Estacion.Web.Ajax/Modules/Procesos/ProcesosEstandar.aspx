<%@ Page Language="C#" AutoEventWireup="true" Codebehind="ProcesosEstandar.aspx.cs"
    Inherits="Servipunto.Estacion.Web.Modules.Procesos.ProcesosEstandar"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <font color="gray"><a onclick="return AbrirVentanaCentrada(this,null,350,340,0,1,0,0,0,1,0)"
                                                                        ...
                                                                        <br>
                                                                        <font color="gray">
                                                                            <asp:Label ID="Label7" runat="server" Text="Generación Archivo Plano de Ventas por Artículo."></asp:Label></font></font></td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                    <td width="50%">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <font color="gray"><a onclick="return AbrirVentanaCentrada(this,null,650,350,0,1,0,0,0,1,0)"
                                                                        ...
                                                                        <br>
                                                                        <asp:Label ID="Label15" runat="server" Text="Genera un archivo de ventas pendientes por transmitir en linea."></asp:Label></font></td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                    <td width="50%">
                                                            ...
                                                            <tr align="left">
                                                                ...
                                                                <td>
                                                                    <font color="gray"><a onclick="return AbrirVentanaCentrada(this,null,650,350,0,1,0,0,0,1,0)"
                                                                        ...
                                                                        <br>
                                                                        <asp:Label ID="Label17" runat="server" Text="Genera un archivo de ventas para manejo de inventarios."></asp:Label></font></td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                </tr>
                                                            ...
                                                            <tr align="left">
                                                                ...
                                                                <td>
                                                                    <font color="gray"><a onclick="return AbrirVentanaCentrada(this,null,650,350,0,1,0,0,0,1,0)"
                                                                        ...
                                                                        <br>
                                                                        <asp:Label ID="Label19" runat="server" Text="Genera un archivo de Lecturas y ventas por fecha y turno"></asp:Label></font></td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                    <td width="50%">
                                                            ...
                                                            <tr align="left">
                                                                ...
                                                                <td>
                                                                    <font color="gray"><a onclick="return AbrirVentanaCentrada(this,null,650,350,0,1,0,0,0,1,0)"
                                                                        ...
                                                                        <br>
                                                                        <asp:Label ID="Label21" runat="server" Text="Genera un archivo de Lecturas y ventas por fecha"></asp:Label></font></td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                </tr>
                                                        ...
                                                        <table id="Table7">
                                                            <tr align="left">
                                                                ...
                                                                <td>
                                                                    <font color="gray"><a onclick="return AbrirVentanaCentrada(this,null,650,350,0,1,0,0,0,1,0)"
                                                                        href="FiltroPlanoVentasInsepec.aspx"><u>
                                                                            <asp:Label ID="Label22" runat="server" Text="Archivo Planos de Ventas Credito o Contado INSEPEC"></asp:Label></u>&nbsp;</a>&nbsp;
                                                                        <br>
                                                                        <asp:Label ID="Label23" runat="server" Text="Genera un archivo de Lecturas y ventas por fecha"></asp:Label></font></td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                </tr>
