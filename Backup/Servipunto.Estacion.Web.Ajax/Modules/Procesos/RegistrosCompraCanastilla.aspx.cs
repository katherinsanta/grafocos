...
{
    public partial class RegistrosCompraCanastilla : System.Web.UI.Page
    {
        ...
        private bool VerificarPermisos()
        {
            ...
            string htmlAcciones = "";
            if (nuevo)
                this.AgregarAccion(ref htmlAcciones, "RegistroCompraCanastilla.aspx", "Crear Registro Compra Canastilla");
            if (eliminar)
        ...
        {
            DataTable ObjConsulta = Servipunto.Estacion.Libreria.RegistrosCompraCanastilla.ObtenerDataTableComprasCanastilla();
        ...
        private void Eliminar()
        {
            if (Request.Form["chkID"] != null)
            {
                ...
                for (i = 0; i <= aSelectedItems.Length - 1; i++)
                {
                    try
                    {
                        Libreria.RegistrosCompraCanastilla.EliminarRegistro(Convert.ToInt32(aSelectedItems[i]));
                    }
                    catch (Exception ex)
                    {
