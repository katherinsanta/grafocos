<%@ Page Language="c#" Codebehind="FiltroTurnoSurtidorArticulo.aspx.cs" AutoEventWireup="true"
    Inherits="Servipunto.Estacion.Reportes.FiltroTurnoSurtidorArticulo" MasterPageFile="~/PaginaMaestra/actualizacion.Master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContenidoMaestro1" runat="server">
    ...
    <asp:Panel ID="pnlForm" Visible="true" runat="server">
        <table cellspacing="1" cellpadding="5" width="650" align="center" bgcolor="#5482fc"
            ...
            <tr>
                <td bgcolor="#eeeeee">
                    <asp:Label ID="lblReporte" runat="server">Reporte de Ventas por Turno -- Surtidor - Articulo</asp:Label></td>
            </tr>
            <tr>
                <td bgcolor="#fefbff">
                    ...
                    <table cellspacing="1" cellpadding="5" width="100%" border="0">
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlTurno" runat="server" Width="176px">
                                </asp:DropDownList></td>
                            <td valign="top">
                        ...
                        <tr>
                            <td style="width: 80px; height: 9px" valign="top">
                                <asp:Label ID="Label3" runat="server" Text="Articulo"></asp:Label>:</td>
                            <td style="height: 9px">
                                <asp:DropDownList ID="ddlArticulo" runat="server" Width="176px">
                                </asp:DropDownList></td>
