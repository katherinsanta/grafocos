<%@ Page Language="c#" Codebehind="FiltroDatosAutomotores.aspx.cs" AutoEventWireup="true"
    Inherits="Servipunto.Estacion.Reportes.FiltroDatosAutomotores" MasterPageFile="~/PaginaMaestra/actualizacion.Master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContenidoMaestro1" runat="server">
    ...
    <asp:Panel ID="pnlForm" Visible="true" runat="server">
        <table cellspacing="1" cellpadding="5" width="90%" align="center" bgcolor="#5482fc"
            ...
            <tr>
                <td bgcolor="#eeeeee">
                    <asp:Label ID="lblReporte" runat="server"><b>Datos de Automotores</b></asp:Label></td>
            </tr>
            <tr>
                <td bgcolor="#fefbff">
                    ...
                    <table cellspacing="1" cellpadding="5" width="100%" border="0">
                        <tr>
                            <td valign="middle">
                                <asp:Label ID="Label1" runat="server" Text="Formato"></asp:Label>:</td>
                            <td valign="middle">
