...
{
    public partial class FiltroConductorConsumo : System.Web.UI.Page
    {
        ...
        private void EjecutarReporte()
        {
            if (this.Validar())
            {
                try
                {
                    ...
                    if (cbTodos.Checked)
                    {
                        if (lblReporte.Text == "<b>Tanking Consumer Drivers Report</b>")
                            report = new Servipunto.Estacion.Web.Modules.Rpt.RptConsumoConductor(FechaInicio.SelectedDate, FechaFin.SelectedDate, 0, 1);
                        else
                            report = new Servipunto.Estacion.Web.Modules.Rpt.RptConsumoConductor(FechaInicio.SelectedDate, FechaFin.SelectedDate, 0, 0);
                    }
                    else
                    {
                        if (lblReporte.Text == "<b>Tanking Consumer Drivers Report</b>")
                            report = new Servipunto.Estacion.Web.Modules.Rpt.RptConsumoConductor(FechaInicio.SelectedDate, FechaFin.SelectedDate, Convert.ToInt32(txtCodigoCliente.Text), 1);
                        else
                            report = new Servipunto.Estacion.Web.Modules.Rpt.RptConsumoConductor(FechaInicio.SelectedDate, FechaFin.SelectedDate, Convert.ToInt32(txtCodigoCliente.Text), 0);
                    }
        ...
        {
            this.lblReporte.Text = "<b>Tanking Consumer Drivers Report</b>";
        ...
        {
            lblConductor.Text = Servipunto.Estacion.Libreria.Configuracion.PalabrasIdioma.Traduccion(23725, Global.Idioma) + ":";
            cbTodos.Text = Servipunto.Estacion.Libreria.Configuracion.PalabrasIdioma.Traduccion(271, Global.Idioma) + " " + Servipunto.Estacion.Libreria.Configuracion.PalabrasIdioma.Traduccion(23725, Global.Idioma) + "s";
