<%@ Page Language="c#" Codebehind="FiltroManguera.aspx.cs" AutoEventWireup="true"
    Inherits="Servipunto.Estacion.Reportes.FiltroManguera" MasterPageFile="~/PaginaMaestra/actualizacion.Master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContenidoMaestro1" runat="server">
    ...
    <asp:Panel ID="pnlForm" Visible="true" runat="server">
        <table cellspacing="1" cellpadding="5" width="650" align="center" bgcolor="#5482fc"
            ...
            <tr>
                <td bgcolor="#eeeeee">
                    <asp:Label ID="lblReporte" runat="server">Reporte de Ventas por Manguera</asp:Label></td>
            </tr>
            <tr>
                <td bgcolor="#fefbff">
                    ...
                    <table cellspacing="1" cellpadding="5" width="100%" border="0">
                        <tr>
                            <td valign="top">
                                <asp:Label ID="Label1" runat="server" Text="Manguera"></asp:Label>:</td>
                            <td>
                                <asp:DropDownList ID="ddlManguera" runat="server" Width="176px">
                                </asp:DropDownList></td>
                            <td valign="top">
                        ...
                        <tr>
                            ...
                            <td valign="top">
                                <asp:Label ID="Label4" runat="server" Text="Fecha Final"></asp:Label>:<br />
