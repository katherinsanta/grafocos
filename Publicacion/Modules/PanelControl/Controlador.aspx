<%@ Page Language="c#" Codebehind="Controlador.aspx.cs" AutoEventWireup="false" Inherits="Servipunto.Estacion.Web.Modules.PanelControl.Controlador"
                                    ...
                                    <td style="padding-right: 30px; padding-left: 40px">
                                        ...
                                        <asp:Panel ID="pnlForm" Visible="true" runat="server">
                                            <table class="ResultsTable" cellspacing="1" cellpadding="4" border="0">
                                                ...
                                                <tr>
                                                    <td class="ResultsItem" valign="middle" align="left" style="height: 145px">
                                                        <table cellpadding="4" border="0">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <asp:Label ID="Label2" runat="server" Text="Puerto Serial:"></asp:Label></td>
                                                                <td>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <asp:Label ID="Label3" runat="server" Text="Puerto de Concentrador:"></asp:Label></td>
                                                                <td>
                                                                    <asp:TextBox ID="txtPuertoConcentrador" Width="112px" MaxLength="40" runat="server"></asp:TextBox>
