<%@ Page Language="c#" Codebehind="FiltroIsla.aspx.cs" AutoEventWireup="true" Inherits="Servipunto.Estacion.Reportes.FiltroIsla"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContenidoMaestro1" runat="server">
    ...
    <asp:Panel ID="pnlForm" Visible="true" runat="server">
        <table width="650" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#5482fc">
            <tr>
                <td bgcolor="#eeeeee">
                    <asp:Label ID="lblReporte" runat="server">Reporte de Ventas por Isla</asp:Label>
                </td>
            </tr>
            <tr>
                <td bgcolor="#fefbff">
                    ...
                    <table width="100%" cellpadding="5" cellspacing="1" border="0">
                        <tr>
                            <td valign="top">
                                <asp:Label ID="Label1" runat="server" Text="Isla"></asp:Label>:</td>
                            <td>
                                <asp:DropDownList ID="cboIsla" runat="server" Width="169px">
                                </asp:DropDownList></td>
                            <td valign="top">
                                <asp:Label ID="Label2" runat="server" Text="Tipo Reporte"></asp:Label>:</td>
                            <td>
