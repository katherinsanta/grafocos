<%@ Page Language="c#" Codebehind="FiltroTurno.aspx.cs" AutoEventWireup="true" Inherits="Servipunto.Estacion.Reportes.FiltroTurno"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContenidoMaestro1" runat="server">
    ...
    <asp:Panel ID="pnlForm" Visible="true" runat="server">
        <table cellspacing="1" cellpadding="5" width="90%" align="center" bgcolor="#5482fc"
            ...
            <tr>
                <td bgcolor="#eeeeee">
                    <asp:Label ID="lblReporte" runat="server">Reporte de Ventas por Turno</asp:Label></td>
            </tr>
            <tr>
                <td bgcolor="#fefbff">
                    ...
                    <table cellspacing="1" cellpadding="5" width="100%" border="0">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:CheckBox ID="cbTodos" runat="server" Text="Todos los turnos" AutoPostBack="True"
