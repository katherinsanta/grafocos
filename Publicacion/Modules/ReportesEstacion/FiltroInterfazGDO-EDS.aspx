<%@ Page language="c#" Codebehind="FiltroInterfazGDO-EDS.aspx.cs" AutoEventWireup="false" 
Inherits="Servipunto.Estacion.Web.Modules.ReportesEstacion.FiltroInterfazGDO_EDS" %>
...
<HTML>
	...
	<body bottomMargin="0" bgColor="#ffffff" leftMargin="0" topMargin="0" rightMargin="0">
		...
		<form id="MyForm" action="FiltroInterfazGDO-EDS.aspx" method="post"
			runat="server">
			<table cellSpacing="1" cellPadding="5" align="center" bgColor="#5482fc" border="0">
				<tr>
					<td bgColor="#eeeeee"><asp:label id="lblReporte" runat="server">Importación Archivo Novedades Recaudo GDO</asp:label></td>
				</tr>
				<tr>
					<td bgColor="#fefbff">
