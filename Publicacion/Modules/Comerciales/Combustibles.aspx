<%@ Page Language="c#" Codebehind="Combustibles.aspx.cs" AutoEventWireup="false"
    Inherits="Servipunto.Estacion.Web.Modules.Comerciales.Combustibles" ValidateRequest="false"
                                            ...
                                            <table class="ResultsTable" cellspacing="1" cellpadding="4" border="0" width="50%">
                                                <tr>
                                                    <td bgcolor="White" valign="middle" colspan="3">
                                                        ...
                                                        <asp:Label ID="lblIdCliente" runat="server" Visible="False"></asp:Label></td>
                                                </tr>
                                                    ...
                                                    <HeaderTemplate>
                                                        <tr>
                                                            <td class="ResultsHeader2" valign="middle" align="center">
                                                                Sel</td>
                                                            <td class="ResultsHeader2" valign="middle" align="center">
                                                                <asp:Label ID="Label1" runat="server" Text='<%#Servipunto.Estacion.Libreria.Configuracion.PalabrasIdioma.Traduccion(263, Servipunto.Estacion.Web.Global.Idioma)%>'></asp:Label></td>
                                                            <td class="ResultsHeader2" valign="middle" align="center">
                                                    ...
                                                    <ItemTemplate>
                                                        <tr class="RowItem" onmouseout="this.className='RowItem';" onmouseover="this.className='SelectedRowItem';">
                                                            <td class="RowTextCentred" valign="middle">
                                                                <input type="checkbox" name="chkID" value='<%# DataBinder.Eval(Container.DataItem, "PlacaAuto") %>|<%# DataBinder.Eval(Container.DataItem, "CodigoArticulo") %>'></td>
                                                            <td class="RowTextCentred" valign="middle">
